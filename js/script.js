const global = {
    ...
    api : {
        API_KEY : '8659107f879a926e07f820abd3af80c7',
...
async function fetchAPIData(endpoint){
    ...
    // In actual projects, the API key should be hidden
...
async function searchAPIData(){
    ...
    const response = await fetch(`${API_URL}search/${global.search.type}
    ?api_key=${API_KEY}&language=en-US&query=${global.search.term}&page=${global.search.page}`);
...
async function search()
{
    ...
    if(global.search.term !== '' && global.search.term !== null)
    {
        ...
        showAlert('Please fill field','error');
...
// Create and display paginator for search
...
// Display backdrop on details page (both movies and shows have a common function)
